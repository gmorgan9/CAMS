...
if(isset($_POST['update-profile'])){
   ...
   if(mysqli_num_rows($result) > 0){
      ...
      $update = "UPDATE student SET fname = '$fname', lname = '$lname', uname = '$uname', email = '$email', gender = '$gender' where studentID = '$sID' ";
              ...
              <div class="card mb-3">
                ...
                <div class="row">
                  ...
                  <div class="row">
                    ...
                    <div class="col-sm-9 text-secondary">
                    <a style="text-decoration: none;" data-bs-toggle="modal" data-bs-target="#editStudent" class="badge text-bg-primary" href="#">Edit</a>
                    </div>
                  </div>
                </div>
              </div>
...
<form action="" method="post">
    ...
    <div class="form-group pt-3" style="width: 35%;">
      <label for="idno" style="font-size: 14px;">Student ID</label>
