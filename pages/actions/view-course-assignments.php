...
<tr>
    ...
    <td>
      ...
      <a style="text-decoration: none; cursor: pointer;" class="badge text-bg-success" data-bs-toggle="modal" data-bs-target="#viewAssignment">View</a>
...
<!-- EDIT MODAL -->
<div class="modal fade" id="viewAssignment" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog">
      <div class="modal-content">
        ...
        <?php 
            $id = $_GET['course_idno'];
            $select = " SELECT * FROM assignment WHERE course_idno = '$id' ";
            $result = mysqli_query($conn, $select);
